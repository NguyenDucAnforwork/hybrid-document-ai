# Model Comparison (SROIE test, n=80) 20260607_0412

## F1 per field

| field | rule-only | logistic-KIE (prod) | LayoutLMv3-base |
|---|---|---|---|
| merchant_name | 0.1875 | 0.0375 | 0.225 |
| date | 0.8 | 0.775 | 0.0 |
| total_amount | 0.0 | 0.4875 | 0.0125 |

## ANLS per field

| field | rule-only | logistic-KIE | LayoutLMv3-base |
|---|---|---|---|
| merchant_name | 0.5463 | 0.0997 | 0.0348 |
| date | 0.8813 | 0.87 | 0.0 |
| total_amount | 0.0 | 0.5396 | 0.0125 |
