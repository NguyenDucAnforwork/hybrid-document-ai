...
| `statement_table_compare_<ngày>.md` + `statement_table_debug_<ngày>/` | rules vs zero-shot Table Transformer vs guarded hybrid; overlay + cell-assignment JSON | `scripts/compare_statement_table_modes.py` |
